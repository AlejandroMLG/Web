<% Response.WriteFile("header.aspx") %>
  <div class="contenedor1140 input_resena">
    <div class="padding16 overflow" style="min-height:600px;">
      ...
      en los 60s con la creación de las hojas "Letraset", las cuales contenian pasajes de Lorem Ipsum, y más recientemente con software de autoedición, como por ejemplo Aldus PageMaker,
      el cual incluye versiones de Lorem Ipsum.</p>
      <button class="caps btn btn-rosa" style="margin-top:24px;">REGRESAR AL HOME</button>
      </div>
    </div>
  </div>
