<% Response.WriteFile("header.aspx") %>
  ...
  <h1 class="azul">¡Tu orden ha sido exitosa!</h1>
  <p class="solid-font18">Tu orden ha sido enviada exitósamente, se te enviara por correo una notificación del resúmen de tu compra.</p>  
  ...
  <div class="contenedor1140 padding16">
    ...
    <p class="solid-font18">Lorem Ipsum es simplemente el texto de relleno de las imprentas y archivos de texto. Lorem Ipsum ha sido el texto de relleno estándar de las industrias desde el año 1500, 
