...
<body>
      ...
      <div class=" menu2_head pull-right">
        ...
        <form class="input_resena padding16 menu2_visible_form" method="post">
          <div>
            ...
            <input class="text-uppercase" placeholder="Ingresa tu e-mail" type="email" size="15" maxlength="60" required>
          </div>
          <div>
            <label class="azul bold text-uppercase">Contraseña <span class="rojo" title="Este campo es obligatorio.">*</span></label><br>
            <input class="text-uppercase" placeholder="Ingresa tu contraseña" type="password" size="15" maxlength="128" required>
          </div>
          <div class="text-center">
            <br><p><a href="nueva-1.aspx" title="Solicitar nueva contraseña por correo electrónico." class="underline">Olvidé mi contraseña</a></p>
            <p><button class="caps btn btn-rosa justificado" type="submit">Entrar</button></p>
            <a href="registro-1.aspx" title="Crear una nueva cuenta de usuario." class="rosa2 solid-font18 bold">Quiero Registrarme</a>
          </div>
        </form>
      </div>
  ...
  <div class="ayuda-lateral">
    <li style="background-color:#a2dae8;"><div class="bold">Contacto</div></li>
    <li style="background-color:#55c4e9;"><a href="f_contacto.aspx"><img src="00_assets/icon_ayuda.png"></a></li>
    <li class="btn-azul"><a href="tel:5555039102" ><img src="00_assets/icon_contacto.png"></a></li>
  </div>
